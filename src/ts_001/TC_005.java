    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (loginForm.isDisplayed()) {
                System.out.println("✅ Account menu or login/register page is displayed.");
            } else {
                throw new Exception("❌ Account section did not appear as expected.");
            }
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot captured: account_navigation_failure.png");

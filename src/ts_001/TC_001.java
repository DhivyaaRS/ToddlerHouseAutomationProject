    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (banner.isDisplayed()) {
                System.out.println("✅ Banner is visible on the homepage.");
            } else {
            ...
            if (bannerWidth > 0) {
                System.out.println("✅ Banner is properly aligned and responsive.");
            } else {
                throw new Exception("❌ Banner alignment/responsiveness issue.");
            }
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot captured: banner_test_failure.png");

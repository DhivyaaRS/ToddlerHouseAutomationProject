...
public class TC_039 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 4: Locate "Blog" navigation link
            WebElement blogLink = driver.findElement(By.linkText("Blog"));

            // Step 5: Check visibility, readability, and alignment
            boolean isVisible = blogLink.isDisplayed();
            boolean isEnabled = blogLink.isEnabled();
            String linkText = blogLink.getText();
            Point location = blogLink.getLocation();
            Dimension size = blogLink.getSize();
...
//            String hoverColor = blogLink.getCssValue("color");

            // Step 7: Click the "Blog" link and verify redirection
            blogLink.click();
            ...
            if (isVisible && isEnabled && isReadable && isProperlyAligned && isRedirected) {
                System.out.println("✅ 'Blog' nav link is visible, readable, aligned, hover effect works, and redirects to homepage.");
            } else {
                System.out.println("❌ 'Blog' nav link validation failed. Visible: " + isVisible +
    		...
    		String claName = TC_039.class.getSimpleName();
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot saved as blog_nav_link_failure.png");

...
public class TC_042 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 5: Hover over the "Search" button
            ...
            try {
                WebElement hoverMessage = driver.findElement(By.xpath("//*[contains(text(),'Search') or contains(@class,'search-icon')]"));
            ...
            if (hoverEffectVisible) {
                System.out.println("✅ Hovering over 'Search' button displays icon or message.");
            } else {
                System.out.println("❌ Hovering over 'Search' button does NOT display icon or message.");
            }
    		...
    		String claName = TC_042.class.getSimpleName();
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot saved as search_hover_failure.png");

...
public class TC_040 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 4: Locate "About Us" navigation link
            ...
            boolean isEnabled = aboutUsLink.isEnabled();
            String linkText = aboutUsLink.getText();
            Point location = aboutUsLink.getLocation();
            Dimension size = aboutUsLink.getSize();

            boolean isReadable = !linkText.trim().isEmpty();
            boolean isProperlyAligned = location.getY() >= 0 && size.getHeight() > 0;

            // Step 6: Click the "About Us" link and verify redirection
            aboutUsLink.click();
            ...
            if (isVisible && isEnabled && isReadable && isProperlyAligned && isRedirected) {
                System.out.println("✅ 'About Us' nav link is visible, readable, aligned, and redirects to homepage.");
            } else {
                System.out.println("❌ 'About Us' nav link validation failed. Visible: " + isVisible +
    		...
    		String claName = TC_040.class.getSimpleName();
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot saved as about_us_nav_link_failure.png");

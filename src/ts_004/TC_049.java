...
public class TC_049 {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (hasResults) {
                System.out.println("✅ Search icon triggered search operation successfully. Relevant results are displayed.");
            } else {
                System.out.println("❌ Search icon did not trigger expected results for keyword 'Busy Book'.");
            }
    		...
    		String claName = TC_049.class.getSimpleName();
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot saved as search_icon_trigger_failure.png");

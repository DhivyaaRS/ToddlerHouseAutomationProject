...
public class TC_027 {
	public static void main(String[] args) {
		...
		try {
			...
			// Step 6: Enter invalid email and valid other fields
			...
			boolean emailErrorDisplayed = driver.getPageSource().toLowerCase().contains("invalid email");

			if (emailErrorDisplayed) {
				System.out.println("✅ Error message displayed for invalid email format.");
			} else {
				System.out.println("❌ Error message NOT displayed for invalid email format.");
			}
    		...
    		String claName = TC_027.class.getSimpleName();
			...
			if (driver != null) {
				...
				try {
					...
					System.out.println("📸 Screenshot saved as email_format_validation_failure.png");

...
public class TC_013 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Step 3: Enter invalid email and any password
            ...
            WebElement errorMessage = driver.findElement(By.xpath("//*[contains(text(),'Enter a valid email address')]")); // Adjust text or selector
            if (errorMessage.isDisplayed()) {
                System.out.println("✅ Error message displayed for invalid email format.");
            } else {
                throw new Exception("❌ Error message not displayed for invalid email format.");
            }
    		...
    		String claName = TC_013.class.getSimpleName();
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot captured: invalid_email_format_failure.png");

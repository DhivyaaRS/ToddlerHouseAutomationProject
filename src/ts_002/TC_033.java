...
public class TC_033 {
    public static void main(String[] args) {
        ...
        try {
            ...
            passwordField.click(); // Simulate clicking inside the field

            // Step 6: Check input type
            String inputType = passwordField.getAttribute("type");

            if ("password".equalsIgnoreCase(inputType)) {
                System.out.println("✅ Password input type is correctly set to 'password'.");
            } else {
                System.out.println("❌ Password input type is NOT set to 'password'. Found: " + inputType);
            }
    		...
    		String claName = TC_033.class.getSimpleName();
            ...
            if (driver != null) {
                ...
                try {
                    ...
                    System.out.println("📸 Screenshot saved as password_input_type_failure.png");

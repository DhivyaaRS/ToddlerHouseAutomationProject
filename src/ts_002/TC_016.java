...
public class TC_016 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Step 3: Locate password field and check its type
			...
			if ("password".equalsIgnoreCase(fieldType)) {
				...
				throw new Exception("❌ Password field is not masked. Found type: " + fieldType);
			}
    		...
    		String claName = TC_016.class.getSimpleName();
			...
			if (driver != null) {
				...
				try {
					...
					System.out.println("📸 Screenshot captured: password_masking_failure.png");
